...
pub fn nrf53_gpio_create_ns<'a>() -> Port<'a, NUM_PINS> {
    Port::new([
        GPIOPin::new(Pin::P0_00, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_01, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_02, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_03, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_04, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_05, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_06, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_07, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_08, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_09, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_10, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_11, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_12, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_13, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_14, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_15, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_16, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_17, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_18, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_19, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_20, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_21, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_22, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_23, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_24, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_25, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_26, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_27, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_28, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_29, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_30, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P0_31, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_00, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_01, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_02, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_03, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_04, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_05, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_06, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_07, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_08, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_09, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_10, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_11, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_12, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_13, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_14, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
        GPIOPin::new(Pin::P1_15, GPIO_BASE_ADDRESS_NONSECURE, GPIOTE1_BASE),
    ])
}
